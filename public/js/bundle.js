...
/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo */ "./todo.jsx");
...
function (_React$Component) {
  ...
  _createClass(Root, [{
    ...
    value: function add(e) {
      ...
      input.value = "";
      _todo__WEBPACK_IMPORTED_MODULE_2__["default"].add({
        content: content
      });
    }
  }, {
      ...
      fetch("http://35.185.197.2/todos").then(function (response) {
        response.json().then(function (data) {
          ...
          data.forEach(function (element) {
            Todo.all.push(new Todo(element));
          });
        });
      });
    }
